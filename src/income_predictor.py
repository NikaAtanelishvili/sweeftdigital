...
# ARCHIVED!
# autoencoder-მა შეცვალა! ესეც იმუშავებდა, მაგრამ ვიფიქრე დინამიურად რომ დაედგინა ცარიელი ველები უკეთესი იქნებოდა.
# ჩვეულებრივი nn-ის შემთხვევაში, თითოეული არასწორი ველისთვის თითო მოდელი დამჭირდებოდა.
